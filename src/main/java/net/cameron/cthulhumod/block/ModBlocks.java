package net.cameron.cthulhumod.block;

import net.cameron.cthulhumod.CthulhuMod;
import net.cameron.cthulhumod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block END_STONE_RUBY_ORE = registerBlock("end_stone_ruby_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.STONE).strength(3f), UniformIntProvider.create(5, 8)));

    //Crops!
    public static final Block TOMATO_CROP = Registry.register(Registries.BLOCK, new Identifier(CthulhuMod.MOD_ID, "tomato_crop"),
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(CthulhuMod.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(CthulhuMod.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }


    public static void registerModBlocks() {
        CthulhuMod.LOGGER.info("Registering ModBlocks for " + CthulhuMod.MOD_ID);
    }
}
