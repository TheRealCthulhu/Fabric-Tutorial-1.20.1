...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ModArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmount, int enchantability, SoundEvent equipSound,
    ...
    public String getName() {
        return CthulhuMod.MOD_ID + ":" + this.name;
    }
